...
import cn.api.apiinterface.common.DeleteRequest;
...
import cn.api.apiinterface.model.dto.user.*;
import cn.api.apiinterface.model.entity.User;
import cn.api.apiinterface.model.vo.UserVO;
...
public class UserController {
    ...
    public BaseResponse<String> userLogin(@RequestBody UserLoginRequest userLoginRequest) {
        ...
        BaseResponse<String> response = userService.userLogin(userAccount, userPassword);
